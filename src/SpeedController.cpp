...
SpeedController::SpeedController(float speedKpSet[NB_PI_SUBSET], float speedKiSet[NB_PI_SUBSET], float setSpeedRange[NB_PI_SUBSET], float outputLimit, float maxInputSpeed, float measureFrequency)
{
    m_speedGoal = 0;
...
void SpeedController::computeGains(float actualSpeed)
{
    ...
    else
    {
        ...
        m_speedKp = fmap(actualSpeed, m_setSpeedRange[set - 1], m_setSpeedRange[set], m_speedKpSet[set - 1], m_speedKpSet[set]);

        m_speedKi = fmap(actualSpeed, m_setSpeedRange[set - 1], m_setSpeedRange[set], m_speedKiSet[set - 1], m_speedKiSet[set]);
    }
}
