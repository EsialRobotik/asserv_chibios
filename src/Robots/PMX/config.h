...
#define BLOCKING_DETECTOR_ANGLE_SPEED_THRESHOLD (M_PI/8) //RAD_PER_S
#define BLOCKING_DETECTOR_DIST_SPEED_THRESHOLD (20)      //MM_PER_S
#define BLOCKING_DETECTOR_BLOCKING_DURATION_THRESHOLD (0.5) //SEC
