...
#define ENCODERS_WHEELS_RADIUS_MM (72.5/2.0)
#define ENCODERS_WHEELS_DISTANCE_MM (88.6)
#define ENCODERS_TICKS_BY_TURN (546*4)

#define REGULATOR_MAX_SPEED_MM_PER_SEC (700)
#define WHEELS_MAX_SPEED_MM_PER_SEC (850)

#define DIST_REGULATOR_KP (5)

#define DIST_REGULATOR_MAX_ACC_FW (900)
#define DIST_REGULATOR_MAX_DEC_FW (900)
#define DIST_REGULATOR_MAX_ACC_BW (900)
#define DIST_REGULATOR_MAX_DEC_BW (900)
#define ACC_DEC_DAMPLING (1.02)
#define DIST_REGULATOR_MAX_ACC_FW_SLOW (900)
#define DIST_REGULATOR_MAX_DEC_FW_SLOW (900)
#define DIST_REGULATOR_MAX_ACC_BW_SLOW (900)
#define DIST_REGULATOR_MAX_DEC_BW_SLOW (900)


#define ANGLE_REGULATOR_KP (300)
#define ANGLE_REGULATOR_MAX_ACC (1000)

#define SPEED_CTRL_LEFT_KP_1 (0.05)
#define SPEED_CTRL_LEFT_KP_2 (0.05)
#define SPEED_CTRL_LEFT_KP_3 (0.05)
#define SPEED_CTRL_LEFT_KI_1 (2.0)
#define SPEED_CTRL_LEFT_KI_2 (1.3)
#define SPEED_CTRL_LEFT_KI_3 (1.3)
#define SPEED_CTRL_LEFT_SPEED_THRES_1 (20)
#define SPEED_CTRL_LEFT_SPEED_THRES_2 (50)
#define SPEED_CTRL_LEFT_SPEED_THRES_3 (60)


#define SPEED_CTRL_RIGHT_KP_1 (0.05)
#define SPEED_CTRL_RIGHT_KP_2 (0.05)
#define SPEED_CTRL_RIGHT_KP_3 (0.05)
#define SPEED_CTRL_RIGHT_KI_1 (2.0)
#define SPEED_CTRL_RIGHT_KI_2 (1.3)
#define SPEED_CTRL_RIGHT_KI_3 (1.3)
...
#define COMMAND_MANAGER_GOTO_ANGLE_THRESHOLD_RAD (M_PI/4)
