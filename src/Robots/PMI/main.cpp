...
{
    encoders = new QuadratureEncoder(&qeESIALCardPinConf_E1ch1_E1ch2_E2ch1_E2ch2, true, true, true, 1.0, 1.0);
    md22MotorController = new Md22(&ESIALCardPinConf_SCL_SDA, true, true, true, 100000);
