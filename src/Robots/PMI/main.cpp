...
#define DIST_REGULATOR_MAX_DECC (-1000)
...
AccelerationDeccelerationLimiter *distanceAccelerationDeccelerationLimiter;
...
static void initAsserv()
{
    ...
    distanceAccelerationDeccelerationLimiter = new AccelerationDeccelerationLimiter(DIST_REGULATOR_MAX_ACC, DIST_REGULATOR_MAX_DECC, 5, MAX_SPEED_MM_PER_SEC, *distanceRegulator);
    ...
    mainAsserv = new AsservMain( ASSERV_THREAD_FREQUENCY, ASSERV_POSITION_DIVISOR,
                           ...
                           *angleRegulator, *distanceRegulator,
                           *angleAccelerationlimiter, *distanceAccelerationDeccelerationLimiter,
